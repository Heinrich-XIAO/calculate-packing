 ...
 *
 * This test demonstrates the space-filling heuristic where two-pin components
 * prefer to be placed perpendicular to the chip edge they connect to.
 *
 * Setup:
 * - A main IC (U1) with pads on top and bottom edges
 * - Several two-pin components (R1, R2, C1, C2) that connect to the IC pads
 *
 * Expected behavior:
 * - Components connecting to top edge pads should extend upward (vertical placement)
 * - Components connecting to bottom edge pads should extend downward (vertical placement)
 * - The space-filling heuristic rewards having one pad close to the chip
 */
